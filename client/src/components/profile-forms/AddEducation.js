...
const AddEducation = ({ addEducation, history }) => {
    ...
    // If the user still works at the job disable "to date"
    ...
    return (
        <Fragment>
            ...
            <p class="lead">
            <i class="fas fa-code-branch"></i> Add any school or college that you have attended</p>
            ...
            <form class="form" onSubmit={e => {
                ...
                <div class="form-group">
                    <input type="text" placeholder="* School Or College" name="school"
